...
public class Recycler_Faq_Adapter_english extends RecyclerView.Adapter<View_Holder> {

    Context context;
    String[] dataSet;
    Boolean flag = false;
    public Recycler_Faq_Adapter_english(String[] data, Context context) {
        dataSet = data;
    ...
    public void onBindViewHolder(final View_Holder holder, final int position) {
        ...
        try {
            ...
            holder.tvAns.setText(ArrayCont.Ans_1[position]);
        }catch (Exception ex){}
