...
//    String[] arrayName;
    ...
    TextView convertedValue,txtunit,clear,otherunit;
           ...
           public void onClick(View view) {
               inputMethodManagerHide(view);
                if (flag % 2 == 0){
                    ...
                    otherunit.setCompoundDrawablesWithIntrinsicBounds( R.drawable.con_ic_arrow_drop_up, 0, 0, 0);
                    flag++;
                }

                else if (flag % 2 != 0){
                    linother.setVisibility(View.GONE);
                    otherunit.setCompoundDrawablesWithIntrinsicBounds( R.drawable.con_ic_arrow_drop_down, 0, 0, 0);
                    flag++;
                }
